...
description: Comprehensive backup system with compression, retention policies, and cloud support
---
...
- [Environment Variables](/lumo-server/configuration/environment/) - Full backup configuration reference
- [Docker Compose](/lumo-server/deployment/docker-compose/) - Backup configuration in Compose
